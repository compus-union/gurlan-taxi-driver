...
import { IonText, IonTitle, IonToolbar, IonIcon, IonButton } from "@ionic/vue";
...
onBeforeMount(async () => {
  ...
  await authStore.checkIfExists({ oneId, token });
});
</script>
  ...
  <div class="still-waiting flex flex-col justify-between h-screen">
    ...
    <div class="box flex flex-col text-center px-1">
      ...
      <IonText
        ...
        tekshirib chiqiladi. Iltimos, akkauntingiz tasdiqlanganidan keyin 3 kun
        ichida offislarimizdan biriga tashrif buyurishingizni so'rab
        qolamiz.</IonText
      >
      <IonButton expand="block" class="font-bold mt-4">Yangilash</IonButton>
    </div>
