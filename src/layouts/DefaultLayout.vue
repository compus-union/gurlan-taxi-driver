...
<template>
	<div class="default-layout">
		<nav class="navbar suit-theme-reverse mx-auto p-2 flex items-center w-full fixed top-0 z-50">
			<DropdownMenu>
				<DropdownMenuTrigger>
					<button class="bg-primary-foreground p-2 flex items-center text-primary rounded-full">
		...
		<router-view class="h-auto fixed bottom-0 w-full z-[49]" v-slot="{ Component }">
